        ...
        <div class="pet-profile">
            <section class="profile-hero">
                <div class="profile-container">
                    <!-- Back Link -->
                    <a href="~/Adoptante/Mascotas.aspx" runat="server" class="back-link">
                    ...
                    <asp:Panel ID="pnlNoEncontrado" runat="server" Visible="false" CssClass="empty-state">
                        ...
                        <a href="~/Adoptante/Mascotas.aspx" runat="server" class="btn-adopt-large"
                        ...
                        <div class="pet-detail-grid">
                            ...
                            <div class="pet-gallery">
                                <div class="gallery-main">
                                    ...
                                    <asp:LinkButton ID="btnFavorito" runat="server" CssClass="favorite-btn"
                                        OnClick="btnFavorito_Click" ToolTip="Agregar a favoritos">
                            ...
                            <div class="pet-info">
                                ...
                                <div class="pet-cta">
                                    <asp:LinkButton ID="btnAdoptar" runat="server" CssClass="btn-adopt-large"
                                        OnClick="btnAdoptar_Click">
