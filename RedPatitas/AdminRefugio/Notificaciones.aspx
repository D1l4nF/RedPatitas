<%@ Page Title="Notificaciones de Administración" Language="C#" MasterPageFile="~/AdminRefugio/AdminRefugio.Master" AutoEventWireup="true" CodeBehind="Notificaciones.aspx.cs" Inherits="RedPatitas.AdminRefugio.Notificaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeader" runat="server">
    <div class="header-section">
        <div>
            ...
            <p>Avisos importantes sobre la plataforma y adopciones</p>
        </div>
