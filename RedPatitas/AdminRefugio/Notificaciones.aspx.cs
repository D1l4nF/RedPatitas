...
namespace RedPatitas.AdminRefugio
{
    public partial class Notificaciones : System.Web.UI.Page
    {
        ...
        private void CargarNotificaciones()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Error al cargar notificaciones AdminRefugio: " + ex.Message);
            }
        }
        ...
        protected void btnMarcarLeidas_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Error al marcar todas como leídas AdminRefugio: " + ex.Message);
            }
        }
        ...
        protected void rptNotificaciones_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Error en comando de notificación AdminRefugio: " + ex.Message);
            }
        }
